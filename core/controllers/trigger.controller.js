app.controller('TriggerController', ['$scope', '$rootScope', '$http', '$auth', 'TriggerDatafactory', '$timeout', function ($scope, $rootScope, $http, $auth, TriggerDatafactory, $timeout) {
    ...
    $scope.triggersOptions = [
        ...
        { Type: 'Issue', Name: 'Issue Updated', code: 'issue_updated', check: false },
        { Type: 'Issue', Name: 'Issue Deleted', code: 'issue_deleted', check: false },     
        { Type: 'Comment', Name: 'Comment Created', code: 'comment_created', check: false },
        { Type: 'Comment', Name: 'Comment Updated', code: 'comment_updated', check: false },
        { Type: 'Comment', Name: 'Comment Deleted', code: 'comment_deleted', check: false },
        { Type: 'Attachment', Name: 'Attachment Created', code: 'attachment_created', check: false },
        { Type: 'Attachment', Name: 'Attachment Deleted', code: 'attachment_deleted', check: false },
        { Type: 'Issue link', Name: 'Issue link Created', code: 'issuelink_created', check: false },
        { Type: 'Issue link', Name: 'Issue link Deleted', code: 'issuelink_deleted', check: false },
        { Type: 'Worklog', Name: 'Worklog Created', code: 'worklog_created', check: false },
        { Type: 'Worklog', Name: 'Worklog Updated', code: 'worklog_updated', check: false },
        { Type: 'Worklog', Name: 'Worklog Deleted', code: 'worklog_deleted', check: false },
        ...
        { Type: 'Board', Name: 'Board Updated', code: 'board_updated', check: false },
        { Type: 'Board', Name: 'Board Deleted', code: 'board_deleted', check: false },
        ...
        { Type: 'Sprint', Name: 'Sprint Updated', code: 'sprint_updated', check: false },
        { Type: 'Sprint', Name: 'Sprint Deleted', code: 'sprint_deleted', check: false },
        ...
        { Type: 'Project', Name: 'Project Deleted', code: 'project_deleted', check: false },
        ...
        { Type: 'Version', Name: 'Version Updated', code: 'version_updated', check: false },
        { Type: 'Version', Name: 'Version Deleted', code: 'version_deleted', check: false },
        ...
        { Type: 'User', Name: 'User Updated', code: 'user_updated', check: false },
        { Type: 'User', Name: 'User Deleted', code: 'user_deleted', check: false }
    ];
